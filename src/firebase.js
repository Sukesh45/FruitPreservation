...
const firebaseConfig = {
  ...
  databaseURL: import.meta.env.FIREBASE_DATABASE_URL || import.meta.env.VITE_FIREBASE_DATABASE_URL,
...
// Analytics is optional and might throw errors if in environment without window/cookie access
let analytics = null;
try {
